...
# Grand House PS4 Exploit Host

<img src="includes/assets/icons/webkitty.svg" width="220" alt="Grand House PS4 Exploit Host Logo">
...
[![GitHub issues](https://img.shields.io/github/issues/ArabPixel/Grand House PS4 Exploit Host)](https://github.com/ArabPixel/Grand House PS4 Exploit Host/issues)
[![GitHub stars](https://img.shields.io/github/stars/ArabPixel/Grand House PS4 Exploit Host)](https://github.com/ArabPixel/Grand House PS4 Exploit Host/stargazers)
...
Open the PS4 web browser and navigate directly https://grandhousee.github.io/

### Option 2: Local Hosting (PC / PS4 Server)
1. Clone the repository:
   ```bash
   git clone https://github.com/ArabPixel/Grand House PS4 Exploit Host.git
   ```
...
You can contribute to Grand House PS4 Exploit Host by:
...
- Reporting bugs or suggesting enhancements via [issues](https://github.com/ArabPixel/Grand House PS4 Exploit Host/issues/new).
...
- **GattoDev:** For the Grand House PS4 Exploit Host logo.
